...
class XpubInitialSubmissionFilesPage(PageObject):
    ...
    # occasionally long xpub file uploads,
    # due to sciencebeam metadata extraction
    TIMEOUT_FILE_PROCESSING = 60

    def populate_required_fields(self):
        self._send_input_to(self.CSS_EDITOR_COVER_LETTER, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. ' * 4, 'cover letter')
    ...
    def _wait_for_upload_and_conversion(self):
        instructions = WebDriverWait(self._driver, self.TIMEOUT_FILE_PROCESSING).until(lambda driver: self._driver.find_element_by_css_selector(self.CSS_UPLOAD_INSTRUCTIONS))
